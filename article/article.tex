...
\keywords{student visa \and international education \and Immigration New Zealand \and statistical analysis \and regional classification}
\end{abstract}
...
The primary source data are publicly available Immigration New Zealand offshore or overseas student visa decision tables for 2022, 2023, 2024, and 2025 \cite{INZ2022,INZ2023,INZ2024,INZ2025}. These INZ data can be obtained directly from Immigration New Zealand. They are also included, together with the other files used in this project, in the project repository on GitHub \cite{KaplanINZRepo}. The repository structure is described in Appendix~\ref{app:repository-structure}. The INZ decision tables report fee-paying student visa decisions by applicant nationality or country. The yearly tables use slightly different column names, but the common information is the country or nationality, number approved, number declined, total or volume of applications, approval rate, and decline rate.
